...
const nftpng =
  "https://ipfs.io/ipfs/bafkreihlcnomdmqxjip4e352jtyyc6ufsgwjok2damdisvmu7ravcuhld4";
...
class App extends Component {
  ...
  async componentDidMount() {
    await axios
      ...
      .then((outputa) => {
        this.setState({ balance: outputa.data });
        ...
        <div className="container">
          <div className="row">
            ...
            >
              ...
              >
                <label style={{ color: "#000000" }} for="floatingInput">
                  Wallet Address
                </label>
              </div>
              <div
              ...
              >
                ...
                {balance.result}/1000 NFTs minted
              </div>
                ...
                return (
                  <div className="card">
                    <div className="image-over">
                      <img className="card-image-top" src={nftpng} alt="" />
                    </div>
                    <div className="card-caption col-12 p-0">
                      <div className="card-body">
                        <h5 className="mb-0">Mystical Inu Collection NFT</h5>
                        <h5 classname="mb-o mt-2">
                          Owner Wallet:
                          <p
                            style={{
                              color: "#39FF14",
